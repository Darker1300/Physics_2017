...
bool Collision::TestCollision(const PhysicsObject * _obj1, const PhysicsObject * _obj2, CollisionInfo & _info)
{
	auto index = (
...
void Collision::ResolveCollision(PhysicsObject * _obj1, PhysicsObject * _obj2, CollisionInfo & _info)
{
	if (_info.collided) {
...
void Collision::HandleSeperation(PhysicsObject * _obj1, PhysicsObject * _obj2, CollisionInfo & _info)
{
...
void Collision::HandleVelocityChange(PhysicsObject * _obj1, PhysicsObject * _obj2, CollisionInfo & _info)
{
	float e = 0.7;
...
bool Collision::TestSpherePlane(const PhysicsObject * _sphere, const PhysicsObject * _plane, CollisionInfo & _info)
{
	Sphere* pSphere = (Sphere*)_sphere->GetShape();
	Plane* pPlane = (Plane*)_plane->GetShape();

	float distFromPlane = ((glm::dot(_sphere->GetPosition(), pPlane->GetNormal())) - _plane->GetPosition().length());
...
bool Collision::TestPlaneSphere(const PhysicsObject * _plane, const PhysicsObject * _sphere, CollisionInfo & _info)
{
